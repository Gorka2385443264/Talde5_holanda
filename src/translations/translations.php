...
{
    $_SESSION["_LANGUAGE"] = "eus"; //Defektuz "nl" hizkuntza jartzen dugu (hemen "en" jarri ezkero, language karpetan en.php izeneko fitxategi bat egon beharko litzateke)
}
...
function trans($indexPhrase)
{
    ...
    //nl.php edo es.php existitzen den begiratzen da
