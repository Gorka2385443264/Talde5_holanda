...
<div id="registrar" class="login-container">
    <div class="info-section">
        ...
        <input type="text" id="fname" name="fname" placeholder="Añade tu correo" style="margin-top: 5px;margin-bottom: 5px; width: 390px;">
        
        <input class="tlf_input" type="tel" id="mnumber" name="mnumber" pattern="[0-9]{9}" placeholder="Añade tu numero de telefono" style="margin-top: 5px;margin-bottom: 5px; width: 390px;">
        <input type="password" id="password" name="password" placeholder="Añade tu contraseña" style="margin-top: 5px; margin-bottom: 5px; width: 390px;">
