<form method="post">
  <div class="opcion_idioma_borde">
    <select class="opcion_idioma" name="selectedLang">
      ...
      // Si el idioma seleccionado en el formulario es nlkera, establecer "selected"
      if (isset($_POST['selectedLang']) && $_POST['selectedLang'] === 'eus') {
        ...
        // Si no se selecciona ningún idioma en el formulario y hay nlkera en la sesión, establecer "selected"
        echo 'selected';
      }
